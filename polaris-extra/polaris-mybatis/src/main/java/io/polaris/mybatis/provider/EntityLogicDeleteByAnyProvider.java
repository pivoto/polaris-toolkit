 ...
 */
@Slf4j
public class EntityLogicDeleteByAnyProvider extends BaseProviderMethodResolver {
	...
	public static String provideSql(Object parameterObject, ProviderContext context) {
		return provideSql(parameterObject, context, (map, ctx)-> {
			String sql = SqlStatements.buildLogicDeleteByAny(map, getEntityClass(context));
