 ...
 */
@Slf4j
public class EntitySelectByAnyDirectProvider extends BaseProviderMethodResolver {
	...
	public static String provideSql(Object parameterObject, ProviderContext context) {
		return provideSql(parameterObject, context, (map, ctx) -> {
			String sql = SqlStatements.buildSelectByAny(map, getEntityClass(context), false);
