...
public class Webs {
	...
	public static String getRemoteAddr(HttpServletRequest request) {
		...
		return Strings.tokenizeToArray(ip, ",")[0];
	}
	...
	public static boolean isLocalAddr(String ip) {
		return Strings.equals(ip, "127.0.0.1") || Strings.equals(ip, "0:0:0:0:0:0:0:1");
	}
	...
	public static byte[] textToNumericFormatV6(String text) {
		...
		while (i1 < m) {
			...
			if (i4 != -1) {
				...
				String str = text.substring(i3, m);
