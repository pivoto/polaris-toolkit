...
public class QrConfig {
	 ...
	 * @return this;
	 */
	public QrConfig setImg(String imgPath) throws IOException {
		return setImg(new File(imgPath));
	}
	 ...
	 * @return this;
	 */
	public QrConfig setImg(File imgFile) throws IOException {
		return setImg(Images.read(imgFile));
	}
