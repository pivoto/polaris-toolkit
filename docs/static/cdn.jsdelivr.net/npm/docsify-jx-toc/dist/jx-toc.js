...
var buildTOC = function(options) {
  ...
  var wrapper = ret;
  var lastLi = null;
	// author Qt 此处浏览器处理匹配问题，添加 .markdown-section 约束
  var selector = options.headings.replace(/,\s*(.markdown-section)?\s*/g,', .markdown-section ')
		.replace(/^\s*(.markdown-section)?\s*/,'.markdown-section ')
