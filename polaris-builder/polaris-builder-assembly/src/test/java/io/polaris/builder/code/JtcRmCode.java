...
//		System.setProperty("project.dir", dir.replaceFirst("/target/test-classes/?$", ""));
		System.setProperty("project.dir", "D:/xcode/jcfc/base/basic/jtc/jtc-rm");
...
//		Codes.generate(SrmConfig.class);
	...
	@CodeWithDefaults(
		...
		tables = {
			@Table(schema = "BASESV", name = "SRM_BIT_POS", javaPackage = "io.polaris.jtc.srm"),
			@Table(schema = "BASESV", name = "SRM_RES_APP", javaPackage = "io.polaris.jtc.srm"),
			@Table(schema = "BASESV", name = "SRM_RES_RPC", javaPackage = "io.polaris.jtc.srm"),
			@Table(schema = "BASESV", name = "SRM_RES_RPC_GROUP", javaPackage = "io.polaris.jtc.srm"),
			@Table(schema = "BASESV", name = "SRM_RES_RPC_GROUP_ITEM", javaPackage = "io.polaris.jtc.srm"),
			@Table(schema = "BASESV", name = "SRM_RES_MQ", javaPackage = "io.polaris.jtc.srm"),
			@Table(schema = "BASESV", name = "SRM_RES_DOC", javaPackage = "io.polaris.jtc.srm"),

			@Table(schema = "BASESV", name = "SRM_AUTHZ_APP", javaPackage = "io.polaris.jtc.srm"),
			@Table(schema = "BASESV", name = "SRM_AUTHZ_APP_MQ", javaPackage = "io.polaris.jtc.srm"),
			@Table(schema = "BASESV", name = "SRM_AUTHZ_APP_RPC", javaPackage = "io.polaris.jtc.srm"),
			@Table(schema = "BASESV", name = "SRM_AUTHZ_APP_RPC_GROUP", javaPackage = "io.polaris.jtc.srm"),
			@Table(schema = "BASESV", name = "SRM_LOG_USER_OPER", javaPackage = "io.polaris.jtc.srm"),

			@Table(schema = "BASESV", name = "SRM_ARCH_SYSTEM_DOMAIN", javaPackage = "io.polaris.jtc.srm"),
			@Table(schema = "BASESV", name = "SRM_ARCH_SYSTEM", javaPackage = "io.polaris.jtc.srm"),
			@Table(schema = "BASESV", name = "SRM_ARCH_NET_ZONE", javaPackage = "io.polaris.jtc.srm"),

			@Table(schema = "BASESV", name = "SRM_AUTHZ_RPC_RPC", javaPackage = "io.polaris.jtc.srm"),
			@Table(schema = "BASESV", name = "SRM_AUTHZ_RPC_RPC_GROUP", javaPackage = "io.polaris.jtc.srm"),

			@Table(schema = "BASESV", name = "SRM_OPENDOC_APP", javaPackage = "io.polaris.jtc.srm"),
			@Table(schema = "BASESV", name = "SRM_ARCH_SYSTEM_MODULE", javaPackage = "io.polaris.jtc.srm"),
			@Table(schema = "BASESV", name = "SRM_ARCH_MACHINE", javaPackage = "io.polaris.jtc.srm"),
			@Table(schema = "BASESV", name = "SRM_ARCH_MACHINE_APP", javaPackage = "io.polaris.jtc.srm"),
			@Table(schema = "BASESV", name = "SRM_ARCH_SYSTEM_CATEGORY", javaPackage = "io.polaris.jtc.srm"),
			@Table(schema = "BASESV", name = "SRM_ARCH_NET_ZONE_REL", javaPackage = "io.polaris.jtc.srm"),
		},
		property = {
