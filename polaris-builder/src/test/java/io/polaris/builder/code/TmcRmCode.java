...
import static io.polaris.builder.code.annotation.Template.VM_PATH_RPC_LIST_OUTPUT;
/**
 * @author Qt
...
//		Codes.generate(SrmUpdateConfig.class);
		Codes.generate(BrmUpdateConfig.class);
	}
...
//			@Property(key = "mapperClassSuffix", value = "Mapper"),
	...
	public static class SrmUpdateConfig {
	}
	...
	public static class BrmUpdateConfig {
	}
