...
//	@Template(path = VM_PATH_RPC_CLIENT, filename = FILENAME_RPC_CLIENT, dirname = DIRNAME_RPC_CLIENT),
	@Template(path = VM_PATH_RPC_CLIENT_EXPORTABLE_INLINE, filename = FILENAME_RPC_CLIENT_INLINE, dirname = DIRNAME_RPC_CLIENT),
	@Template(path = VM_PATH_RPC_CLIENT_EXPORTABLE, filename = FILENAME_RPC_CLIENT, dirname = DIRNAME_RPC_CLIENT),
