...
<project xsi:schemaLocation="http://maven.apache.org/POM/4.0.0 https://maven.apache.org/xsd/maven-4.0.0.xsd" xmlns="http://maven.apache.org/POM/4.0.0"
	...
	<scm>
		<connection>scm:git:git@gitee.com:pivoto/polaris.git</connection>
		<developerConnection>scm:git:git@gitee.com:pivoto/polaris.git</developerConnection>
		<url>git@gitee.com:pivoto/polaris.git</url>
	</scm>
</project>
' > tools-${version}.pom
...
mkdir -p ~/.m2/repository/cn/pivoto/jdk/tools/${version}/
cp -f *.jar ~/.m2/repository/cn/pivoto/jdk/tools/${version}/
cp -f *.pom ~/.m2/repository/cn/pivoto/jdk/tools/${version}/
cp -f *.asc ~/.m2/repository/cn/pivoto/jdk/tools/${version}/
cp -f *.md5 ~/.m2/repository/cn/pivoto/jdk/tools/${version}/
cp -f *.sha1 ~/.m2/repository/cn/pivoto/jdk/tools/${version}/

rm -rf cn/
mkdir -p cn/pivoto/jdk/tools/${version}/
cp -f *.jar cn/pivoto/jdk/tools/${version}/
cp -f *.pom cn/pivoto/jdk/tools/${version}/
cp -f *.asc cn/pivoto/jdk/tools/${version}/
cp -f *.md5 cn/pivoto/jdk/tools/${version}/
cp -f *.sha1 cn/pivoto/jdk/tools/${version}/
...
curl --request POST \
  ...
  --form bundle=@bundle.zip \
	--form name=cn.pivoto.jdk:tools:${version} \
