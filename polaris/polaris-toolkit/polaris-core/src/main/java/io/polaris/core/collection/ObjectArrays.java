...
public class ObjectArrays extends PrimitiveArrays {
	...
	public static <T> T firstNonNull(T... array) {
		return firstMatch(Objs::isNotNull, array);
	}
	...
	public static Object[] cast(Class<?> type, Object arrayObj) throws NullPointerException, IllegalArgumentException {
		...
		final Object[] result = ObjectArrays.newArray(componentType, array.length);
	...
	public static <T extends CharSequence> T[] removeEmpty(T[] array) {
		return filter(array, Strings::isNotEmpty);
	}
	...
	public static <T extends CharSequence> T[] removeBlank(T[] array) {
		return filter(array, Strings::isNotBlank);
	}
	...
	public static String[] nullToEmpty(String[] array) {
		return edit(array, t -> null == t ? SymbolConsts.EMPTY : t);
	}
	...
	public static <T> String join(T[] array, CharSequence delimiter, String prefix, String suffix) {
		...
		joinAll(joiner, o -> prefix + o + suffix, array);
	...
	private static void joinAll(StringJoiner joiner, Function<Object, String> converter, Object array) {
		if (array == null) {
			...
			((Iterable<?>) array).forEach(o -> joinAll(joiner, converter, o));
		} else if (array instanceof Iterator) {
			((Iterator<?>) array).forEachRemaining(o -> joinAll(joiner, converter, o));
		} else if (array.getClass().isArray()) {
			int length = Array.getLength(array);
			for (int i = 0; i < length; i++) {
				joinAll(joiner, converter, Array.get(array, i));
			}
		} else {
	...
	public static <T> String join(T[] array, CharSequence conjunction, Function<T, T> editor) {
		...
		joinAll(joiner, o -> String.valueOf(editor.apply((T) o)), array);
		return joiner.toString();
	}
	...
	public static String join(Object array, CharSequence conjunction) {
		...
		StringJoiner joiner = new StringJoiner(conjunction);
		joinAll(joiner, String::valueOf, array);
		return joiner.toString();
	}
	...
	public static <T> T[] toArray(Iterable<T> iterable, Class<T> componentType) {
		Collection<T> collection = (iterable instanceof Collection) ? (Collection<T>) iterable : Iterables.asList(iterable.iterator());
	...
	public static <T extends Comparable<? super T>> T min(T[] numberArray, Comparator<T> comparator) {
		...
		T min = numberArray[0];
		for (T t : numberArray) {
			if (Comparators.compare(min, t, comparator) > 0) {
				min = t;
			}
		}
		return min;
	...
	public static <T extends Comparable<? super T>> T max(T[] numberArray, Comparator<T> comparator) {
		...
		for (int i = 1; i < numberArray.length; i++) {
			if (Comparators.compare(max, numberArray[i], comparator) < 0) {
				max = numberArray[i];
			}
		}
		return max;
	...
	/**
	 * 计算{@code null}或空元素对象的个数，通过{@link Objs#isEmpty(Object)} 判断元素
	 *
	...
	public static <T, K> T[] distinct(T[] array, Function<T, K> uniqueGenerator, boolean override) {
		...
		return toArray(map.values(), (Class<T>) getComponentType(array));
	}
	...
	public static boolean equals(Object array1, Object array2) {
		...
		Assertions.assertTrue(isArray(array1), "First is not a Array !");
		Assertions.assertTrue(isArray(array2), "Second is not a Array !");
