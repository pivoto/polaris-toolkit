 ...
 * @since 1.8
 */
public class MessageCheckedException extends Exception implements IErrorCode {
	...
	public static MessageCheckedException of(Throwable e) {
		return e instanceof MessageCheckedException ? (MessageCheckedException) e : new MessageCheckedException(e);
	}

	public static MessageCheckedException of(Throwable e, String message) {
		return e instanceof MessageCheckedException ? (MessageCheckedException) e : new MessageCheckedException(e, message);
	}
