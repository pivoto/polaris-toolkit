...
public class Assertions {
	...
	public static <T> void assertInstanceOf(Class<T> expectedType, Object actualValue, String message) throws AssertionException {
	...
	public static <T> void assertNotInstanceOf(Class<T> expectedType, Object actualValue, String message) throws AssertionException {
		if (expectedType.isInstance(actualValue)) {
			throw new AssertionException(buildPrefix(message)
