...
@Documented
@Conditional(ConditionalOnAllProperty.OnCondition.class)
	...
	class OnCondition extends SpringBootCondition {
		...
		public ConditionOutcome getMatchOutcome(ConditionContext context, AnnotatedTypeMetadata metadata) {
			AnnotationAttributes attributes = AnnotationAttributes.fromMap(
					metadata.getAnnotationAttributes(ConditionalOnAllProperty.class.getName()));
			if (attributes == null) {
				return ConditionOutcome.noMatch(
						ConditionMessage.forCondition(ConditionalOnAllProperty.class)
								.because("no metadata"));
			}
		...
		static class Spec {
			...
			private ConditionOutcome matched() {
				ConditionMessage message = ConditionMessage.forCondition(ConditionalOnAllProperty.class)
						.because("match " + this.toString() + "");
