 ...
 * <ul>
 * In summary:
 * <li>Sorted by generation time;
 * </li><li>Can be stored as a UUID/GUID;
 * </li><li>Can be stored as a string of 26 chars;
 * </li><li>Can be stored as an array of 16 bytes;
 * </li><li>String format is encoded to Crockford's base32;
 * </li><li>String format is URL safe, is case insensitive, and has no hyphens.
 * </li></ul>
 * <p>
