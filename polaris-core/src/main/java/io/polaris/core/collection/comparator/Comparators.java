...
public class Comparators {
	...
	public static <T> Comparator<T> comparingPinyin(Function<T, String> keyExtractor, boolean reverse) {
		...
		if (reverse) {
			return (o1, o2) -> comparator.compare(keyExtractor.apply(o2), keyExtractor.apply(o1));
		}
		return (o1, o2) -> comparator.compare(keyExtractor.apply(o1), keyExtractor.apply(o2));
	}
