...
public class Xml {
	...
	public static Document readXML(@Nonnull String pathOrContent) throws IOException {
		...
		return readXML(IO.getInputStream(pathOrContent));
	}
	...
	public static String toStr(Node doc, boolean isPretty) throws IOException {
		return toStr(doc, StdConsts.UTF_8, isPretty);
	}
	...
	public static String cleanInvalid(String xmlContent) {
		...
		return xmlContent.replaceAll(INVALID_REGEX, SymbolConsts.EMPTY);
	}
	...
	public static String cleanComment(String xmlContent) {
		...
		return xmlContent.replaceAll(COMMENT_REGEX, SymbolConsts.EMPTY);
	}
	...
	public static String mapToXmlStr(Map<?, ?> data, boolean omitXmlDeclaration) throws IOException {
		return toStr(mapToXml(data, "xml"), StdConsts.UTF_8, false, omitXmlDeclaration);
	}
	...
	public static String mapToXmlStr(Map<?, ?> data, String rootName, String namespace, boolean omitXmlDeclaration) throws IOException {
		return toStr(mapToXml(data, rootName, namespace), StdConsts.UTF_8, false, omitXmlDeclaration);
	}
	...
	public static String mapToXmlStr(Map<?, ?> data, String rootName, String namespace, boolean isPretty, boolean omitXmlDeclaration) throws IOException {
		return toStr(mapToXml(data, rootName, namespace), StdConsts.UTF_8, isPretty, omitXmlDeclaration);
	}
	...
	public static class UniversalNamespaceCache implements NamespaceContext {
		...
		private final Map<String, String> prefixUri = new HashMap<>();
